...
(v6.1 — MOND Derived, SPARC Validated)}

\author{Peter Angelov\\
Independent Researcher\\
\texttt{tervion@gmail.com}}

\date{March 2026 (v6.1 — 18 March 2026)}
...
projection $v_{3D} = v/\sqrt{3}$ (unique: confirmed as the only factor among 12 candidates
with both $<5\%$ error and an independent physical derivation); (4) threshold
...
vs prediction $w_\text{eff} \approx -1.08$, 3.5$\sigma$ tension). The cosmological sector
