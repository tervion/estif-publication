...
(v) The ESTIF cosmological dark energy sector was found inconsistent with DESI DR2 BAO data and is under revision; no cosmological claims are made here. *(v6.3 note: Path One frozen-eddy limit now ties $\Lambda$CDM on DESI DR2, $\chi^2/N = 1.92$; Path Two thawing derivation is in progress.)*
