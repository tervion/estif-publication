...
> **Target location in repo:** project root `README.md`
...
- **Gravity** is the local tilt/slowing of the flow near mass — and its field
  equation is now *derived*, not borrowed (see below).
...
| Gravity — EHT / Λ / LISA (local tilt) | ✅ 0.00σ / ratio 1.0000 / 49.2σ |
...
3. **No dark matter / dark energy.** Ωm = x₀ (0.12%), a₀ = H₀cx₀/√3 (1.72% MOND);
   halo structure needs N-body (documented wall).
