...
CACHE = {
    'dr1_mean': os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "docs", "dr1_mean.txt"),
    'dr1_cov':  os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "docs", "dr1_cov.txt"),
    'dr2_mean': os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "docs", "dr2_mean.txt"),
    'dr2_cov':  os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "docs", "dr2_cov.txt"),
}
