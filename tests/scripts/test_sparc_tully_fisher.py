...
SPARC_LOCAL = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "docs", "SPARC_Lelli2016c.xml")
...
def load_sparc(votable_path=None):
    ...
    paths_to_try.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "docs", "SPARC_Lelli2016c.mrt"))
    paths_to_try.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "docs", "sparc_vizier.tsv"))
