...
print("-" * 74)
print("[3] MANDATORY FILTER - the boost must VANISH by low z (sigma8 / S8)")
print("-" * 74)
s8_planck = 0.8111
print(f"  If a 13% growth enhancement PERSISTED to z=0: sigma8 -> "
      f"{s8_planck} x 1.13 = {s8_planck*1.13:.3f}")
print(f"  Planck sigma8 = {s8_planck:.3f};  weak-lensing S8 ~ 0.76-0.78 (already LOWER).")
print(f"  -> sigma8 = {s8_planck*1.13:.2f} is GROSSLY EXCLUDED (>5 sigma) and in the")
print("     WRONG direction (low-z data mildly prefer SUPPRESSED growth).")
print()
print("  THEREFORE D_ESTIF(z) cannot be a constant boost. It MUST be transient:")
print("     strong at z ~ 9  (D_ESTIF/D_LCDM ~ 1.13)")
print("     -> negligible by z <~ 2  (D_ESTIF/D_LCDM -> 1 today).")
print("  This is a HARD filter on the modified-gravity form: the growth")
print("  enhancement must switch OFF as dark energy / low-z structure takes over.")
print("  Any derived D_ESTIF(z) that fails this is falsified by S8 regardless of")
print("  what it does for JWST.")
print()
print("-" * 74)
