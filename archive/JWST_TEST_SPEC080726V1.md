...
This is a **small, plausible** modification — ESTIF does not need to double growth,
only nudge it ~13%.
...
3. **If ≳ 1.13:** ESTIF relieves the JWST tension with a derived, zero-free-parameter
   growth enhancement — a genuine, distinguishing, falsifiable win exactly where
   ΛCDM strains. This would be a flagship result.
