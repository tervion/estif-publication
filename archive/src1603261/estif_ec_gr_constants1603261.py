...
# Tilt suppression is now geometric — BETA_DRAG = 1.0 is the
# unsuppressed Lorentz correction. Actual observable β is
# position-dependent: β(r) = √(1 - (Rs/r)^(2n))
# EHT-constrained tilt exponent: n = 0.05 – 0.215
# See tests/test_tilt_scan.py and tests/test_lisa_tilt_scan.py
BETA_DRAG = 1.0  # Full Lorentz correction — suppressed by beta_tilt() in model
