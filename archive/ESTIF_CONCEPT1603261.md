...
- **Complete cosmological replacement**
  The distance-redshift relation has not been derived from first
  principles within the tilt geometry. The current supernova tests
  use a perturbative correction to ΛCDM rather than a standalone
  cosmological model. The functional form of x(z) — how the tilt
  geometry experiences cosmic expansion — remains undetermined.
...
through. The room has a measurable size. And the room is slowly growing.
