...
The Ωm = x₀ numerical coincidence is confirmed to 0.12%. The physical
derivation connecting the 4D eddy to the stress-energy tensor is future
theoretical work. The galactic rotation curve extension is Phase 7.1.

See: `tests/test_eddy_dark_matter.py`, `tests/test_eddy_time_gravity.py`
...
- `tests/test_baryons_only_cosmology.py` — Baryons-only Friedmann equation test
